...
/// Halaman Beranda Dosen Pembimbing - UI/UX Upgraded
class DosenBeranda extends StatefulWidget {
  const DosenBeranda({super.key});

  @override
  State<DosenBeranda> createState() => _DosenBerandaState();
}

class _DosenBerandaState extends State<DosenBeranda>
                    ...
                    children: [
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  auth.pengguna?.namaLengkap ?? 'Dosen',
                                  style: Theme.of(context)
                                      .textTheme
                                      .headlineSmall
                                      ?.copyWith(
                      ...
                      Consumer<PengajuanProvider>(
                        builder: (context, prov, _) {
                          final mhsBimbingan = prov.daftarPengajuan
                              .where((p) => p.isDisetujui)
                              .length;
                          final perluVerifikasi = prov.daftarPengajuan
